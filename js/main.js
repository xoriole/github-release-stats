...
function showStats(data) {
  ...
  if (err) {
    html +=
      "<div class='col-md-6 col-md-offset-3 alert alert-danger output'>" +
      errMessage +
      "</div>";
  } else {
    ...
    if (totalDownloadCount) {
      ...
      totalHTML +=
        "<h1><span class='glyphicon glyphicon-download'></span>&nbsp;&nbsp;Total Downloads</h1>";
      totalHTML +=
        "<span class='label label-info text-large'>" +
        formatNumber(totalDownloadCount) +
        "</span>";
      totalHTML += "</div>";
